...
class VLLMClient:
    _SYSTEM_PROMPT = (
        ...
        "Каждый фрагмент контекста помечен идентификатором документа в формате [DOC-ID]. "
        "Обязательно упоминай в ответе, какие документы регламентируют описываемый процесс, "
        "используя их ID (например: «согласно INS-HR-001» или «документ POL-HR-001 устанавливает»). "
